...
abstract class Animal {
  ...
  public Animal(String norName,
    ...
    if(norName == null || latName == null || latFamily == null || arrivalDate == null || address == null || norName.trim().equals("") || latFamily.trim().equals("") || latFamily.trim().equals("") || address.trim().equals("")) {
